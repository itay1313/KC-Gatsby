...
import FaqWidgetItem from "./Faq/FaqWidgetItem"
      ...
      <RichTextElement
        ...
        resolveLinkedItem={linkedItem => {
          switch (get(linkedItem, "system.type")) {
            ...
            case "iframe_widget": {
              let iframeSrc = linkedItem.elements.iframe_src.value
              let iframeHeight = linkedItem.elements.iframe_height.value
              let iframeWidth = linkedItem.elements.iframe_width.value
              let iframeBorder = linkedItem.elements.iframe_border.value
              return (
                <div className="my-6">
                  <iframe
                    style={{
                    ...
                    className="mx-auto sipad:w-full"
                    width={`${iframeWidth}%`}
                    height={iframeHeight}
                    title="iframe"
                    src={iframeSrc}
