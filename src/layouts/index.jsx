...
const BodyStyles = styled.div`
  ...
  *:not(.drop-btn, .search-tags, button:not(.btn), input):focus {
...
const Layout = ({ children, location }) => {
  ...
  return (
    <BodyStyles className="layout">
      ...
      <GlobalStyles />
      <Header />
      <div className="max-width w-full min-h-screen drawer lg:overflow-auto ipad:drawer-end drawer-mobile overflow-y-visible gap-8 lg:h-auto">
        <input
          id="my-drawer-2"
          type="checkbox"
